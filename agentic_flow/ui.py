                    ...
                    h(
                        ...
                        h(
                            "input",
                            {
                                ...
                                "className": "hidden",
                                "type": "file",
                                "accept": ".pdf,.txt,.md,.markdown,.csv,.json,.xml,.html,.yaml,.yml,.docx,.xlsx,image/*,video/*,audio/*",
                            },
                        ),
                        h("span", {"id": "asset-file-label"}, "PDF, texto, imagem, vídeo ou áudio"),
                    ),
                ),
                h(
                    "div",
...
def ProvidersPage(props):
    ...
    return h(
        ...
        h(
            ...
            h(
                "section",
                {"className": "dashboard-heading local-model-heading"},
                h(
                    "div",
                    None,
                    h("span", {"className": "auth-kicker"}, "SELF-HOSTED"),
                    h("h1", None, "Biblioteca de modelos"),
                    h("p", None, "Escolha um modelo do Hugging Face. O AgenticFlow cuida do download, hardware e configuração."),
                ),
                h(
                    "button",
                    {"className": "button secondary", "id": "new-local-model-button"},
                    Icon("settings-2", 17),
                    "Instalar por ID",
                ),
            ),
            h(
                ...
                h(
                    "div",
                    {"className": "model-library-toolbar"},
                    h(
                        "label",
                        {"className": "model-search"},
                        Icon("search", 18),
                        h("input", {"id": "model-library-search", "placeholder": "Buscar modelos, organizações ou capacidades…", "autocomplete": "off"}),
                    ),
                    h("div", {"className": "model-task-tabs", "id": "model-task-tabs"}),
                    h(
                        "details",
                        {"className": "model-library-access"},
                        h("summary", None, Icon("key-round", 15), "Modelos privados"),
                        h("div", {"className": "field"}, h("label", {"htmlFor": "model-library-token"}, "Token do Hugging Face"), h("input", {"id": "model-library-token", "type": "password", "autocomplete": "off", "placeholder": "hf_…"}), h("small", {"className": "field-help"}, "Usado apenas durante o download; não é salvo.")),
                    ),
                ),
                h("div", {"className": "model-hardware-card", "id": "local-hardware"}, "Detectando hardware…"),
                h("div", {"className": "model-library-feedback hidden", "id": "model-library-feedback"}),
                h(
                    "div",
                    {"className": "model-section-head"},
                    h("div", None, h("h2", None, "Modelos disponíveis"), h("p", {"id": "model-discovery-caption"}, "Recomendados para seu hardware")),
                    h(
                        "div",
                        {"className": "model-catalog-controls"},
                        h("span", {"className": "model-result-count", "id": "model-result-count"}, ""),
                        h(
                            "label",
                            {"className": "model-sort-control"},
                            h("span", None, "Ordenar por"),
                            h(
                                "select",
                                {"id": "model-sort"},
                                h("option", {"value": "trending"}, "Em alta"),
                                h("option", {"value": "downloads"}, "Mais baixados"),
                                h("option", {"value": "likes"}, "Mais curtidos"),
                                h("option", {"value": "updated"}, "Atualizados recentemente"),
                            ),
                        ),
                    ),
                ),
                h("section", {"className": "model-discovery-grid", "id": "model-discovery-grid"}, h("div", {"className": "model-library-loading"}, "Buscando modelos no Hugging Face…")),
                h(
                    "nav",
                    {"className": "model-pagination hidden", "id": "model-pagination", "aria-label": "Páginas de modelos"},
                ),
                h(
                    "div",
                    {"className": "model-section-head installed-models-head"},
                    h("div", None, h("h2", None, "Instalados neste workspace"), h("p", None, "Prontos para selecionar nos nós do workflow")),
                ),
                h("section", {"className": "model-installed-grid", "id": "local-model-grid"}),
            ),
        ),
        h(
            "div",
        ...
        h(
            "div",
            {"className": "modal-backdrop hidden", "id": "local-model-modal"},
            h(
                "form",
                {"className": "workflow-modal provider-modal", "id": "local-model-form"},
                h("button", {"type": "button", "className": "modal-close", "id": "local-model-modal-close", "aria-label": "Fechar"}, Icon("x", 18)),
                h("span", {"className": "auth-kicker"}, "HUGGING FACE HUB"),
                h("h2", None, "Instalar modelo local"),
                h("div", {"className": "field"}, h("label", {"htmlFor": "local-repository"}, "Pesquisar ou informar repositório"), h("input", {"id": "local-repository", "required": True, "placeholder": "org/model-name", "list": "huggingface-model-options", "autocomplete": "off"}), h("datalist", {"id": "huggingface-model-options"}), h("small", {"className": "field-help"}, "A pesquisa consulta diretamente o Hugging Face Hub.")),
                h("div", {"className": "field"}, h("label", {"htmlFor": "local-task"}, "Modalidade"), h("select", {"id": "local-task", "required": True})),
                h("div", {"className": "field"}, h("label", {"htmlFor": "local-revision"}, "Revisão"), h("input", {"id": "local-revision", "value": "main", "required": True})),
                h("div", {"className": "field"}, h("label", {"htmlFor": "local-token"}, "Token HF (somente modelos privados)"), h("input", {"id": "local-token", "type": "password", "autocomplete": "off"})),
                h("div", {"className": "provider-note"}, "O AgenticFlow detecta automaticamente modelos que exigem código próprio e configura o runtime durante a instalação."),
                h("div", {"className": "auth-error hidden", "id": "local-model-error"}),
                h("div", {"className": "provider-form-actions"}, h("span", None), h("button", {"className": "button primary", "type": "submit"}, "Baixar e instalar")),
            ),
        ),
        h(
            "div",
            {"className": "modal-backdrop hidden", "id": "gguf-variant-modal"},
            h(
                "form",
                {"className": "workflow-modal provider-modal", "id": "gguf-variant-form"},
                h("button", {"type": "button", "className": "modal-close", "id": "gguf-variant-close", "aria-label": "Fechar"}, Icon("x", 18)),
                h("span", {"className": "auth-kicker"}, "LLAMA.CPP · GGUF"),
                h("h2", None, "Escolher quantização"),
                h("p", {"className": "provider-note", "id": "gguf-repository-label"}, ""),
                h("div", {"className": "model-library-loading hidden", "id": "gguf-loading"}, "Consultando arquivos GGUF no Hugging Face…"),
                h("div", {"className": "field", "id": "gguf-variant-field"}, h("label", {"htmlFor": "gguf-variant-select"}, "Versão do modelo"), h("select", {"id": "gguf-variant-select", "required": True}), h("small", {"className": "field-help", "id": "gguf-variant-help"}, "")),
                h("div", {"className": "field hidden", "id": "gguf-mmproj-field"}, h("label", {"htmlFor": "gguf-mmproj-select"}, "Projetor multimodal (imagem)"), h("select", {"id": "gguf-mmproj-select"}), h("small", {"className": "field-help"}, "Opcional. Necessário somente para modelos GGUF que recebem imagens.")),
                h("div", {"className": "provider-note"}, "O AgenticFlow baixa apenas a quantização escolhida e usa o backend mais adequado: ROCm/HIP, CUDA, Vulkan ou CPU."),
                h("div", {"className": "auth-error hidden", "id": "gguf-variant-error"}),
                h("div", {"className": "provider-form-actions"}, h("span", None), h("button", {"className": "button primary", "type": "submit", "id": "gguf-install-button"}, "Baixar e instalar")),
            ),
        ),
    )
