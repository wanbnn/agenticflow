    ...
    return h(
        ...
        h(
            ...
            h(
                ...
                h(
                    ...
                    h("h1", None, "Modelos Hugging Face locais"),
                    h("p", None, "Baixe e execute LLM, visão, áudio, imagem e 3D no próprio servidor."),
                ),
                h(
                    "button",
                    {"className": "button primary", "id": "new-local-model-button"},
                    Icon("download", 17),
                    "Instalar modelo",
                ),
            ),
            h("div", {"className": "security-banner", "id": "local-hardware"}, "Detectando hardware…"),
            h("section", {"className": "provider-grid", "id": "local-model-grid"}),
        ),
        h(
            "div",
        ...
        h(
            ...
            h(
                ...
                h("label", {"className": "toggle-field"}, h("input", {"id": "local-trust-code", "type": "checkbox"}), h("span", None), "Permitir código remoto do repositório"),
